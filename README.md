...
<p align="center">
  <a href="https://meemkhaan.github.io/smart-invoicify/"><strong>▶ Product website</strong></a>
  &nbsp;·&nbsp;
  <a href="https://smart-invoicify.vercel.app/"><strong>Live app</strong></a>
  &nbsp;·&nbsp;
  <a href="https://demo-smart-invoicify.vercel.app/demo/request"><strong>Try interactive demo</strong></a>
  &nbsp;·&nbsp;
...
| | |
|---|---|
| **Product site** | [meemkhaan.github.io/smart-invoicify](https://meemkhaan.github.io/smart-invoicify/) |
| **Production** | [smart-invoicify.vercel.app](https://smart-invoicify.vercel.app/) |
| **Interactive demo** | [Request sandbox access](https://demo-smart-invoicify.vercel.app/demo/request) (email verification) |
| **Built with** | Next.js · React · TypeScript · Supabase |

> **This is the public product repository.** It contains marketing materials and screenshots only.  
> **Application source code is not published here** — it is provided under license to customers by Reach Solutions.
...
_Add or replace images in [`docs/screenshots/`](./docs/screenshots/)._

### Dashboard

![Dashboard — overview of recent documents and metrics](./docs/screenshots/hero-dashboard.png)

### Quotation / proposal editor

![Quotation editor — line items, totals, and status](./docs/screenshots/quotation-editor.png)

### Branded PDF

![Branded PDF export with company logo and signature](./docs/screenshots/invoice-pdf.png)

### Clients & catalog

![Clients and product catalog](./docs/screenshots/clients-catalog.png)

### Reports

![Reports — sales and profit views](./docs/screenshots/reports-profit.png)

### Admin settings

![Settings — company, Telegram, activity log](./docs/screenshots/settings-admin.png)

### Mobile

![Mobile layout with bottom navigation](./docs/screenshots/mobile-nav.png)

---

## Video walkthroughs

_Add **MP4** or **WebM** files to [`docs/videos/`](./docs/videos/), or embed YouTube/Loom links below._
...
Request access to the **hosted sandbox**: [demo-smart-invoicify.vercel.app/demo/request](https://demo-smart-invoicify.vercel.app/demo/request).

You will receive a verification email, then explore sample data. Document email send is disabled in the demo; share links and WhatsApp flows are available.

---

## Licensing

Smart Invoicify is **proprietary software**. Source access, deployment rights, and support are granted under a **license agreement** with Reach Solutions.
...
<p align="center">
  <strong>Smart Invoicify</strong> — proposals, quotations, and invoices with clarity and control.<br>
  <sub><a href="https://meemkhaan.github.io/smart-invoicify/">Product website</a> · <a href="https://demo-smart-invoicify.vercel.app/demo/request">Request demo</a></sub>
</p>
